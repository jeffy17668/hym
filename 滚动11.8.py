...
report_orde['大项目名称']=report_orde['大项目名称'].replace('空值','',regex=True).astype(str)
...
report_outtt['大项目名称']=report_outtt['大项目名称'].replace('空值','',regex=True).astype(str)
...
report_accepttt['大项目名称']=report_accepttt['大项目名称'].replace('空值','',regex=True).astype(str)
